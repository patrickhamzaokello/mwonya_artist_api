...
if (!isset($data) || (!isset($data['admin_id']) && !isset($data['email']))) {
    http_response_code(400);
    echo json_encode([
        'status' => 'error',
        'message' => 'Provide a valid admin.',
    ]);
    exit;
}
...
try {
    ...
    $result = null;
    $result = $handler->getListofCreators($data['admin_id'], $data['email']);
